...
$premium_dashboard_url = esc_url( Config::premiumDashboardUrl() );
			...
			<div class="wpgdprc-form__intro">
				...
				">
					<?php
						...
						printf( esc_html_x( 'Style your Consent Bar and Consent Pop-up via the Cookie Information dashboard %1s.', 'admin', 'wp-gdpr-compliance' ), "<a href=\"$premium_dashboard_url\">" . esc_html_x( 'here', 'admin', 'wp-gdpr-compliance' ) . '</a>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					?>
				</p>
			</div>
		</div>

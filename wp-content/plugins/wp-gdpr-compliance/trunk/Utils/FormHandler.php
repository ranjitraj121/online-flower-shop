...
class FormHandler {
	...
	public static function consentEditFormRedirect( $args = [] ) {
        ...
        echo '<script>location.href = "' . filter_var( add_query_arg( $args, PageDashboard::getTabUrl( PageDashboard::TAB_PROCESSORS ) ), FILTER_VALIDATE_URL, FILTER_FLAG_PATH_REQUIRED ) . '";</script>';
		die();
	}
}

...
class Account_Controller {
	...
	public function is_cs_connected() {
		...
		$api_auth_provider = WP_CROWDSIGNAL_FORMS::instance()->get_api_authenticator();
		...
		$is_verified = WP_CROWDSIGNAL_FORMS::instance()->get_api_gateway()->get_is_user_verified();
	...
	public function get_cs_account_info() {
		$summary = WP_CROWDSIGNAL_FORMS::instance()->get_api_gateway()->get_account_info();

...
/**
 * Class WP_CROWDSIGNAL_FORMS_Api_Authenticator
 */
class WP_CROWDSIGNAL_FORMS_Api_Authenticator {
	 ...
	 *
	 * @var WP_CROWDSIGNAL_FORMS\Auth\Api_Auth_Provider_Interface class
	 */
	private $auth_provider;

	/**
	 * WP_CROWDSIGNAL_FORMS_Authenticator constructor
	 */
	 ...
	 *
	 * @return WP_CROWDSIGNAL_FORMS\Auth\Api_Auth_Provider_Interface provider instance
	 */
	private function get_auth_provider() {
		return apply_filters( 'WP_CROWDSIGNAL_FORMS_get_auth_provider', new Default_Api_Auth_Provider() );
	}

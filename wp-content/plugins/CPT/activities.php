...
if (!function_exists('wpqa_show_activities')) :
	function wpqa_show_activities($whats_type_result,$show_date = "") {
		...
		if (!empty($whats_type_result["post_id"])) {
			if ($whats_type_result["text"] == "add_group" || $whats_type_result["text"] == "delete_group" || $whats_type_result["text"] == "delete_posts" || $whats_type_result["text"] == "posts_like" || $whats_type_result["text"] == "posts_unlike" || $whats_type_result["text"] == "accept_invite" || $whats_type_result["text"] == "decline_invite" || $whats_type_result["text"] == "add_posts" || $whats_type_result["text"] == "approved_group" || $whats_type_result["text"] == "approved_posts") {
				$get_the_permalink = wpqa_custom_permalink($whats_type_result["post_id"],"view_posts_group","view_group_post");
			}else {
				$get_the_permalink = get_the_permalink($whats_type_result["post_id"]);
			}
			$get_post = get_post($whats_type_result["post_id"]);
		...
		if (!empty($whats_type_result["comment_id"])) {
			...
			if ($whats_type_result["text"] == "add_comment" && isset($get_post->post_type) && $get_post->post_type == "posts") {
				$get_the_permalink = wpqa_custom_permalink($whats_type_result["post_id"],"view_posts_group","view_group_post");
			}
		}
		...
		if (!empty($whats_type_result["post_id"]) && empty($whats_type_result["comment_id"]) && $get_post_status != "trash" && isset($get_the_permalink) && $get_the_permalink != "") {
			...
			}else if ($whats_type_result["text"] == "block_user") {
				$output .= esc_html__("You have blocked user","wpqa");
			}else if ($whats_type_result["text"] == "unblock_user") {
		...
		if (($whats_type_result["text"] == "ban_user" || $whats_type_result["text"] == "unban_user" || $whats_type_result["text"] == "block_user" || $whats_type_result["text"] == "unblock_user" || $whats_type_result["text"] == "user_follow" || $whats_type_result["text"] == "user_unfollow") && !empty($whats_type_result["another_user_id"])) {

...
<form action="" data-os-success-action="reload" data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'save_columns_for_bookings_table'); ?>">
	...
	<div class="latepoint-lightbox-footer">
		<button type="submit" class="latepoint-btn latepoint-btn-block latepoint-btn-lg latepoint-btn-outline latepoint-save-day-schedule-btn"><?php _e('Save Table Columns', 'latepoint'); ?></button>
	</div>
</form>
...
$load_prev_btn_html = '<div class="os-availability-prev-w">
												<a href="#" data-start-date="'. $calendar_start_date.'" 
...
<?php if($show_days_only){ ?>
	<?php if($showing_previous_days) echo $load_prev_btn_html; ?>
	<?php echo $days_availability_html; ?>
	<?php if(!$showing_previous_days) echo $load_more_btn_html; ?>
	<?php
}else{ ?>

  ...
  <form action="" 
    ...
    <div class="os-form-content">
      ...
      <div class="payment-info-w">
        ...
        <?php if($booking->payment_method || $booking->payment_portion || OsPaymentsHelper::get_enabled_payment_methods()){ ?>
          <div class="os-row">
            <div class="os-col-lg-6">
              <?php echo OsFormHelper::select_field('booking[payment_method]', __('Payment Method', 'latepoint'), OsBookingHelper::get_payment_methods_select_list(), $booking->payment_method, [], [], true); ?>
            </div>
            <div class="os-col-lg-6">
        ...
        <div class="os-row">
          ...
          <div class="os-col-lg-6">
            <a href="#" class="latepoint-btn latepoint-btn-white trigger-price-recalculate" data-route="<?php echo OsRouterHelper::build_route_name('bookings', 'calculate_full_price') ?>">
              <i class="latepoint-icon latepoint-icon-refresh-cw"></i>
              <span><?php _e('Recalculate', 'latepoint'); ?></span>
            </a>
          </div>
        </div>
      <?php do_action('latepoint_booking_quick_form_payment_info_after', $booking); ?>
      </div>
    ...
    <div class="os-form-buttons">
      <div class="os-row">
        <?php if($booking->is_new_record()) { ?>
          <div class="os-col-12">
            <button type="submit" class="latepoint-btn latepoint-btn-block"><?php _e('Create Appointment', 'latepoint'); ?></button>
          </div>
        <?php }else{ ?>
          <div class="os-col-10">
          ...
          <div class="os-col-2">
            <a href="#" data-os-success-action="reload" data-os-action="<?php echo OsRouterHelper::build_route_name('bookings', 'delete'); ?>" data-os-params="<?php echo OsUtilHelper::build_os_params(['booking_id' => $booking->id]); ?>" data-os-prompt="<?php _e('Are you sure you want to delete this appointment?', 'latepoint'); ?>" class="latepoint-delete-appointment latepoint-btn latepoint-btn-secondary" title="<?php _e('Delete Appointment', 'latepoint'); ?>"><i class="latepoint-icon latepoint-icon-trash-2"></i></a>
          </div>
        <?php } ?>
      </div>
    </div>

<form data-os-reminder-id="<?php echo $reminder['id']; ?>" 
	...
	<div class="os-reminder-form-i">
		...
		<div class="os-reminder-form-params">
			...
			<div class="os-row">
				<div class="os-col-12">
	        <?php OsFormHelper::wp_editor_field('reminders['.$reminder['id'].'][content]', 'reminders_'.$reminder['id'].'_content', __('Message', 'latepoint'), $reminder['content'], array('editor_height' => 100)); ?>
				</div>
			</div>

<div class="latepoint-side-menu-w <?php echo (OsAuthHelper::is_admin_logged_in()) ? 'side-menu-'.OsSettingsHelper::get_menu_layout_style() : 'side-menu-compact'; ?>">
	...
	<ul class="side-menu">
		...
		foreach(OsMenuHelper::get_side_menu_items() as $menu_item){
			...
			?>
			<li class="<?php if(isset($menu_item['show_notice']) && $menu_item['show_notice']) echo ' latepoint-show-notice ' ;?><?php if(isset($menu_item['children'])) echo ' has-children'; ?><?php if($is_active) echo ' menu-item-is-active'; ?>">

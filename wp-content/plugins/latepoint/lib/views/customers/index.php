  ...
  <div class="table-with-pagination-w">
    <div class="os-pagination-w">
      ...
      <div class="table-actions">
        <a href="<?php echo OsRouterHelper::build_admin_post_link(OsRouterHelper::build_route_name('customers', 'index') ) ?>" target="_blank" class="latepoint-btn latepoint-btn-outline latepoint-btn-sm download-csv-with-filters"><i class="latepoint-icon latepoint-icon-download"></i><span><?php _e('Download .csv', 'latepoint'); ?></span></a>
        <?php if(OsAuthHelper::wp_users_as_customers()){ ?>
          ...
          <?php if($not_connected_count){ ?>
            <a href="#" data-os-success-action="reload" data-os-action="<?php echo OsRouterHelper::build_route_name('customers', 'connect_all_to_wp_users'); ?>" class="latepoint-btn latepoint-btn-outline latepoint-btn-sm"><i class="latepoint-icon latepoint-icon-wordpress"></i><span><?php _e('Connect to WP Users', 'latepoint'); ?><?php echo ' ['.$not_connected_count.']'; ?></span></a>
          <?php } ?>
        <?php } ?>
      </div>
    </div>

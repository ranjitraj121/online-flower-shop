...
class OsActivityModel extends OsModel{
  ...
  function __construct($id = false){
    ...
    $this->codes = array( 'customer_create' => __('New Customer Registration', 'latepoint'), 
                      ...
                      'service_update' => __('Service Updated', 'latepoint'),
                      'service_create' => __('Service Created', 'latepoint'),
                      'location_update' => __('Location Updated', 'latepoint'),
                      'location_create' => __('Location Created', 'latepoint'),
                    );

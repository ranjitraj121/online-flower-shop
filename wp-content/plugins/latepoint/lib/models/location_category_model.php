...
class OsLocationCategoryModel extends OsModel{
  ...
  public function count_locations(){
    ...
    $total_location = $location->where(['category_id' => $this->id])->should_be_active()->count();
  ...
  public function get_active_locations(){
    if(!isset($this->location)){
      ...
      $this->location = $location->get_results_as_models();
    }
  ...
  protected function get_locations(){
    if(!isset($this->location)){
      $location = new OsLocationModel();
      $this->location = $location->where(array('category_id'=> $this->id))->order_by('order_number asc')->get_results_as_models();
    }
    return $this->location;
  }

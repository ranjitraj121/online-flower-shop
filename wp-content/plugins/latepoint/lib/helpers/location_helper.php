          ...
          <div class="os-category-children">
            ...
            if(is_array($location_category->locations)){
              foreach($location_category->locations as $location){
                echo '<div class="item-in-category-w status-'.$location->status.'" data-id="'.$location->id.'"><div class="os-category-item-drag"></div><div class="os-category-item-name">'.$location->name.'</div><div class="os-category-item-meta">ID: '.$location->id.'</div></div>';
              }
            } ?>

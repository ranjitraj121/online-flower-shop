...
if (!function_exists('wpqa_login_jquery')) :
	function wpqa_login_jquery() {
		...
		$allow_login_nonce = apply_filters("wpqa_allow_login_nonce",true);
		if ($allow_login_nonce == true && (!isset($_POST['wpqa_login_nonce']) || !wp_verify_nonce($_POST['wpqa_login_nonce'],'wpqa_login_nonce'))) {

					...
					<?php echo "<div class='user-section user-section-small row user-not-normal".($crown_king == "on"?" widget-user-crown":"")."'>";
						...
						if (isset($query)) {
							...
							foreach ($query as $user) {
								...
								echo "<div class='col col12'>".wpqa_author($user,"small",$owner_widget,($user_sort == "post_count"?"post":$user_sort),"widget","","",(isset($term_id) && $term_id !== ""?$term_id:(isset($first_points) && $first_points !== ""?$first_points:"")),(isset($show_icon) && $show_icon == "on"?$show_icon:""),($active_points_specific == "on" && $specific_points == "on" && $specific_time != ""?$specific_time:""))."</div>";
							}
						}?>
					</div>
				</div>

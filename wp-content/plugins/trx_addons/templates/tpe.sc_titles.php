...
var title_text2 = settings.title2 || '';
	...
	title_html += '<' + title_tag
				...
				+ '>'
					...
					+ ( settings.title_style == 'gradient'
						? '<span class="trx_addons_text_gradient sc_item_title_text"'
					...
					+ ( title_text2 != ''
						? '<span class="sc_item_title_text2">'
								+ trx_addons_prepare_macros(title_text2)
							+ '</span>'
						: ''
						)
					+ ( ! trx_addons_is_off(settings.subtitle_align) && subtitle_align != title_align
